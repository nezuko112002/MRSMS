...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-brand-500/15 focus:text-brand-600 dark:focus:text-brand-300',
      'data-[highlighted]:bg-brand-500/15 data-[highlighted]:text-brand-600 dark:data-[highlighted]:text-brand-300',
